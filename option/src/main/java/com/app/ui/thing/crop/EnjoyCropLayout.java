...
import com.app.ui.thing.crop.core.IShape;
import com.app.ui.thing.crop.core.clippath.ClipPathCircle;
import com.app.ui.thing.crop.core.clippath.ClipPathLayerView;
import com.app.ui.thing.crop.core.clippath.ClipPathSquare;
import com.app.ui.thing.crop.core.image.EnjoyImageView;
...
public class EnjoyCropLayout extends FrameLayout {
    ...
    public Bitmap crop() {
        ...
        if (mLayerView == null) {
            DLog.e(" layerView is null");
        }
        if (mImageView.getDrawable() == null) {
            DLog.e("ImageView 'drawable is null");
            return null;
        }
        if (!(mImageView.getDrawable() instanceof BitmapDrawable)) {
            DLog.e("only support the type of BitmapDrawable");
            return null;
        }
        IShape iShape = mLayerView.getShape();
        if (iShape == null) {
            DLog.e("shape is null");
            return null;
        }
